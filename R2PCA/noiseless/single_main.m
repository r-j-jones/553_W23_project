...
p = .02;% Probability of nonzero entry in sparse component
mu = 2;    % Coherence: value in [1,d/r]
v = 10;         % variance of the sparse entries

[err,Time,mu] = runExperiment(d,N,r,p,v,mu);
...
% =========================== GENERAL SETUP ============================
% ======================================================================
d = 10;        % Size of the matrix = d x N
N = d;
r = 2;          % rank of low-rank component
P = 0.05; %.01:.04:.17;% Probability of nonzero entry in sparse component
Mu = 1; %2:4:19;    % Coherence: value in [1,d/r]
v = 10;         % variance of the sparse entries
