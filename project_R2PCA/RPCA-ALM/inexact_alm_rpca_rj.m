function [A_hat, E_hat, iter] = inexact_alm_rpca_rj(D, lambda, tol, max_iter, rho, verbose)
...
while ~converged1 || ~converged2
    ...
    if (~converged1 || ~converged2) && iter >= max_iter && verbose==1
